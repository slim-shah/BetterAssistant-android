...
//
//                    }
                    String textResponse = "Error in parsing response";
                    ...
                    if (value.getDialogStateOut() != null
                        ...
                        textResponse = value.getDialogStateOut().getSupplementalDisplayText();
                    }

                    final String finalResponse = textResponse;
                    Log.println(Log.INFO, "#HandlerMessage", finalResponse);
                    mConversationHandler.post(() -> mConversationCallback.onResponseStarted(finalResponse.getBytes()));
                }
    ...
    public void startConversation() {
       ...
       /* mAssistantHandler.post(() -> {
            ...
            //added by me !
            dialogStateInBuilder.setConversationState(ByteString.EMPTY);
